...
<body>
								...
								while ($row = mysqli_fetch_array($result)) {
									...
									if (!$alreadyInFav) {
										...
										if (!mysqli_query($con, $sql)) {
											...
											echo '<div id="message" style="text-align:center;color:red;">*Internship was stored in favourites!*<div>';
										}	
									}
									else{
	...
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBaroyMVsaglg06ZjPXiIdpftfRz0cmvXI&callback=myMap"></script>
</body>
</html>